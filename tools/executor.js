...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      // market regime
      marketRegimeEnabled: ["marketRegime", "enabled"],
      marketRegimeMode: ["marketRegime", "mode"],
      currentRegime: ["marketRegime", "currentRegime"],
      bearStrategy: ["marketRegime", "bearStrategy"],
      bullStrategy: ["marketRegime", "bullStrategy"],
      neutralStrategy: ["marketRegime", "neutralStrategy"],
      solPriceChangeThreshold: ["marketRegime", "solPriceChangeThreshold"],
      solPriceRecoveryThreshold: ["marketRegime", "solPriceRecoveryThreshold"],
